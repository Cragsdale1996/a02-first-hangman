defmodule Hangman.Game do
    ...
    def make_move(game = %Game{}, guess) do
        ...
        new_game_state = game
                         ...
                         |> process_and_score_guess(guess)

        { 
            new_game_state, 
            new_game_state |> tally() 
        }
    ...
    defp process_and_score_guess(game = %Game{ status: :already_used }, _guess) do 
        game
    end

    defp process_and_score_guess(game = %Game{ status: :initializing }, guess) do
        game
    ...
    defp check_for_win_or_loss(game = %Game{ turns_left: 0 }) do 
        %{ game | 
            status: :lost 
        }
    end
